...
bronze_path=f"gs://{GCS_BUCKET}/landing/retailer-db/categories/*.json"
silver_path=f"gs://{GCS_BUCKET}/silver/categories/"


print("▶️ Processing Table: categories fullload")
...
print("▶️ Silver layer table categories saved")